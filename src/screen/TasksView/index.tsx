    ...
    if (newTaskTitle) {
      try {
        const response = await fetch('http://192.168.1.115:5000/tasks', {
          ...
          body: JSON.stringify({ title: newTaskTitle, description: newTaskDescription, completed: false }),
        });
  ...
  return (
    <View style={styles.container}>
      ...
      <TaskModal
        ...
        saveTask={editingTaskId ? () => handleEditTask(newTaskTitle, newTaskDescription) : createTask}
